...
\begin{frame}
        \centering \includegraphics[width=\textwidth]{pictures/sponsors} \\
\end{frame}
...
\begin{frame}
    ...
    \pause
    \vspace{3cm}
    {\Large\textbf{ProVogon !}}
\end{frame}

\begin{frame}
	\frametitle{ProVogon}
	\begin{itemize}
        \item Entreprise de construction galactique
        \item Travaux d'envergure extrêmes
        \item Requièrent une énergie importante
	\end{itemize}
\end{frame}

\begin{frame}
	\frametitle{Collecte d'énergie}
    Source d'énergie :
    \begin{itemize}
        \item Propre
        \item Basée sur les énergies solaires
        \item Ne dégageant pas de CO2
    \end{itemize}

    \vspace{2cm}
    \pause
    \ldots \textbf{l'aspiration d'étoiles !}
\end{frame}

\begin{frame}
	\frametitle{Notre outil}
    \centering
    \includegraphics[width=6cm]{pictures/tuyau}
\end{frame}
