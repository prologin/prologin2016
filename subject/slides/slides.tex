    ...
    \begin{columns}[T]
        ...
        \begin{column}{.7\textwidth}
            \begin{itemize}
                ...
                \item Se déplace dans la direction qui le rapproche le plus d'une base
                \item Disparaît s'il n'est relié à aucune base à la fin d'un tour
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{.7\textwidth}
            \begin{itemize}
                ...
                \item 5 points d'aspiration maximum par case
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
